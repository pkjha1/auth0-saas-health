    ...
    <div className="container relative sm:grid h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        ...
        <div className="relative z-20 flex items-center text-lg font-medium">
          ...
          <span className="font-semibold">Quzones</span>
        </div>
        <div className="relative z-20 m-auto max-w-sm text-center">
          <blockquote className="space-y-2">
            <div className="space-y-8">
              ...
              <p className="text-lg">
                Quzones by Dimechain OÜ is driving breakthrough in Healthcare, logistics, portfolio optimization, drug discovery, material science, traffic management, defense and supply chains. 
              </p>
            </div>
          </blockquote>
        </div>
